 ...
 float lastSongX13t;
 float shuffleX36t;
 float playButtonX13 = pause1ButtonX = nextSongX13t = lastSongX = line4X = rectX + rectW * 1/4;
 float playButtonX2 = lastSongX13t = shuffleX36t = rectX + rectW * 3/4;
 float playButtonY1 = pause1ButtonY = nextSongY = pause2ButtonY = lastSongY = rectY + rectH * 1/4;
